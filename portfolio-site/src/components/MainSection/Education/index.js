        ...
        <div className="education-details">
          <div className="education-info">
            ...
            <ul>
              ...
              <li>Dean's List (Academic Year 2020 - 2021)</li>
              <li>
                NTU President Research Scholar - Computer Vision Undergraduate
                Researcher (AY19/20)
              </li>
              <li>
                NTU Open Source Society – President (AY20/21), TGIFHacks Chair
                (AY19/20), HackOSS Admin for Data Analysis (AY18/19)
              </li>
              <li>
